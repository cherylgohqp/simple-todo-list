  ...
  const updateCardHandler = () => {
    ...
    axios
      .put(`${API_URL}/api/cards/${parseInt(selectedCardIndex)}`, {
        header: editHeader, // Use edited state
        value: editValue,   // Use edited state
      })
      .then((response) => {
    ...
    return (
      ...
      >
        ...
        <input
          className={classes.modal_input}
          value={editHeader}
          onChange={(e) => setEditHeader(e.target.value)} // Update state correctly
          placeholder="Task Title"
        />
        ...
        <input
          className={classes.modal_input}
          value={editValue}
          onChange={(e) => setEditValue(e.target.value)} // Update state correctly
          placeholder="Task Description"
        />
      </Modal>
    );
